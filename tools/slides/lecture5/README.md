...
The course deck inherits the existing starter PPTX theme and uses Arial, matching Lecture 4. Text, equations, and the comparison tables are editable. Simulation screenshots and GIFs are captured from the runnable Localization demos, not pre-scripted pose interpolation.
...
4. Run `tools/slides/lecture5/build.mjs` using the bundled Node runtime. This imports the starter deck, exports and renders 36 slides, and finalizes the PPTX.
