...
for item in list(out.iterdir()):
 if item.name in ['perception','sensor-fusion','downloads']:continue
...
for page in [perception/'index.html',out/'sensor-fusion/index.html']:
 s=page.read_text()
...
print('Course portal built with perception/ and sensor-fusion/')
