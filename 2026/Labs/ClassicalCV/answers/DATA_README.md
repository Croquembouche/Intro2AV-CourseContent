...
The `msg/` folder contains flattened YAML message data for direct use with
`ros2 topic pub`. These are inspectable input files, not executable helpers.
Digit matrices use `std_msgs/msg/Int32MultiArray`; image paths use
`std_msgs/msg/String`. Visualization is performed by the ROS 2 nodes.
