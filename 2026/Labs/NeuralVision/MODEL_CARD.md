...
- The drawing pad does not silently center inputs. Use **Center** when desired; this fits the drawing to a 20×20 bounding box inside the 28×28 image. Shifts remain visible in the actual input.
